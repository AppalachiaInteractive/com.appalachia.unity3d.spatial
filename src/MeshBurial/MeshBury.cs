    ...
    public class MeshBury : EditorOnlyBehaviour
    {
        ...
        private void Update()
        {
            try
            {
                ...
                var degreeAdjustment = _burialOptions.permissiveness *
                                       (_burialOptions.minimalRotation ? _state.optimizationParams.xzDegreeAdjustmentMinimal : _state.optimizationParams.xzDegreeAdjustment);
        ...
        private void OnDrawGizmosSelected()
        {
            ...
            if (drawTriangles.v)
            {
                ...
                UnityEditor.Handles.color = triangleColor.v;
                UnityEditor.Handles.DrawLines(_triVerts);
            }
            ...
            if (drawVertices.v)
            {
                ...
                UnityEditor.Handles.color = vertexColor.v;

                UnityEditor.Handles.DrawLines(_verts);
            }
            ...
            if (drawBorders.v)
            {
                ...
                UnityEditor.Handles.color = borderColor.v;
                UnityEditor.Handles.DrawLines(_borders);
            }
            ...
            if (drawBorderNormals.v)
            {
                ...
                UnityEditor.Handles.color = borderColor.v;
                UnityEditor.Handles.DrawLines(_borderNormals);
            }
            ...
            if (drawOriginalVertices.v)
            {
                ...
                UnityEditor.Handles.color = originalVertexColor.v;
                UnityEditor.Handles.DrawLines(_triVertsOriginal);
            }
            ...
            SmartHandles.DrawWireSphere(pos, gizmoRadius.v * 2.0f, _recent.proposed.error < errorThreshold ? Color.green : Color.red);
            ...
            if (drawRotation.v)
            {
                ...
                var meshBorderRotation = quaternion.LookRotationSafe(m.MultiplyVector(_meshObject.data.BorderNormal), float3c.up);
                ...
                SmartHandles.DrawWireSphere(calculatedIndicatorPosition, gizmoRadius.v, calculatedAdjustmentColor.v);
