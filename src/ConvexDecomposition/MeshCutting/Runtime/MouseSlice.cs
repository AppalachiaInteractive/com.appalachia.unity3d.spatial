...
#region Utility Functions
        ...
        bool SliceObject(ref Plane sliceObjectPlane, GameObject obj, List<Transform> positiveObjects, List<Transform> negativeObjects)
        {
        ...
        /// </summary>
        void ReplaceMesh(Mesh mesh, TempMesh tempMesh, MeshCollider c = null)
        {
            mesh.Clear();
